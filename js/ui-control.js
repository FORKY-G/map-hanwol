...
function showLevelDetail(level) {
    ...
    for (const category in data) {
        ...
        catTitle.style.cssText = 'font-weight:900; background:#2a211a; color:#ffcc00; padding:8px; margin-top:15px; border-left:4px solid #ffd700; font-size:13px;';
