...
const npcData = [
    ...
    { name: "기록서(사도연)", x: 1539, y: 196, z: 4654, quest: "사도연 : 퀘스트 시작", route: "기록서 > 풍잔객 > 고대의제작대(정적주제작) > 청풍초 > 풍잔객 > 사도연검 > 풍잔객 ", file: "memo.png"},
    { name: "풍잔객", lv: 50, x: 3031, y: 104, z:4286, quest: "사도연 : 바람의목격자", route: "풍잔객 > 정적주제작 > 청풍초 > 풍잔객", records: [{n : "청풍초", x: 3050, y: 207, z: 4388}, { n: "사도연-검", x: 3081, y: 109, z: 4174}], reward: "초살선풍", file: "pung.png"},
