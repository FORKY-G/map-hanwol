...
const npcData = [
    ...
    { name: "명인대장장이", x: -7047, y: 74, z: -727, quest: "???", file: "mungin.png", crafting: [{ name: "송진칠료", materials: "송진덩어리1 + 적동괴1 + 갈옥1 + 돌덩어리2", img: "item1.png"}, { name: "와편분말", materials: "깨진기와1 + 돌덩어리5 + 철1 + 적동석1", img: "item2.png"}, { name: "목심재", materials: "고목조각1 + 철1 + 갈옥1 + 돌덩어리2", img: "item3.png"}, { name: "목판", materials: "낡은목간2 + 강철1 + 송진덩어리2 + 돌덩어리2", img: "item4.png"}, { name: "옥장식편", materials: "깨진옥장식2 + 자금1 + 청연광3 + 돌덩어리2", img: "item5.png"}, 
    { name: "기와문양판", materials: "깨진기와2 + 강철1 + 적동괴1 + 송진덩어리1 + 돌덩어리2", img: "item6.png"}, { name: "접합제", materials: "송진칠료1 + 강철2 + 돌덩어리3 + 갈옥1 + 향목가루1", img: "item7.png"}, { name: "청동각인판", materials: "와편분말1 + 오금철1 + 청동파편2 + 매화옥1 + 청연광2 ", img: "item8.png"}, { name: "강화목", materials: "목심재1 + 백련강1 + 신선옥2 + 마모된인장2 + 돌덩어리2", img: "item9.png"},  { name: "기문부적", materials: "목판1 + 백련정강1 + 청강석2 + 잔존영석3", img: "item10.png"},
    { name: "정련실", materials: "기와문양판1 + 강오금1 + 현철2 + 연마사3", img: "item11.png"}, { name: "옥문장식판", materials: "옥장식편1 + 백현철1 + 무괴철1 + 매화옥2 + 봉인된철편3", img: "item12.png"}, { name: "한철단조석", materials: "접합제2 + 한철2 + 금강석1 + 연마사2 + 봉인된철편4", img: "item13.png"}, { name: "설화정련석", materials: "청동각인판2 + 빙옥5 + 청강석2 + 흑옥4 + 잔존영석4", img: "item14.png"}, { name: "금강각인편", materials: "강화목2 + 금강석3 + 깨진옥장식2 + 자금1 + 연마사4", img: "item15.png"}]},
